...
from SAM.datasets.inference_dataset import InferenceDataset
from SAM.datasets.augmentations import AgeTransformer
from SAM.utils.common import tensor2im, log_image
from SAM.options.test_options import TestOptions
